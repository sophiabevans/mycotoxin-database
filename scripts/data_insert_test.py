...
if (form):
    ...
    rem_biotran = form.getvalue("rem_biotran", "")
    rem_reg = form.getvalue("rem_reg", "")
    rem_adsorp = form.getvalue("rem_adsorp", "")
    rem_absorp = form.getvalue("rem_absorp", "")
    rem_deg = form.getvalue("rem_deg", "")
    rem_reg = form.getvalue("rem_reg", "")
    rem_unknown = form.getvalue("rem_unknown", "")
    rem_other = form.getvalue("rem_other", "")
    if rem_other != "":
